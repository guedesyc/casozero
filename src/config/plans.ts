...
export const PLANS = {
  ...
  caso_tres: { id:'caso_tres' as const, name:'CasoTrês', price:299.90, maxLawyers:10, monthlyIntakes:300, areaLinks:true, advancedAnalytics:true, customBranding:true, advancedCriteria:true, teamManagement:true, description:'Para profissionais com equipe.' },
} as const;
